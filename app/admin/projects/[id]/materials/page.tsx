...
export default async function MaterialsPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const materials = await getMaterialsByProject(id).catch(() => [])
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex gap-2 mb-6">
            {[
              ...
              { href: `/admin/projects/${id}/materials`, label: '装修材料', active: true },
            ].map(t => (
          ...
          <div className="flex items-center justify-between mb-4">
            <h1 className="text-xl font-bold text-gray-900">装修材料</h1>
            <Link href={`/admin/projects/${id}/materials/new`}
          ...
          <MaterialList materials={materials} projectId={id} categoryLabels={MATERIAL_CATEGORY_LABELS} />
        </div>
      </main>
    </div>
  )
